                                ...
                                <tbody>
                                    ...
                                    if (isset($_POST['filter_tgl'])) {
                                        ...
                                        if (!empty($mulai) && !empty($selesai)) {
                                            ...
                                            $stmt = $conn->prepare("SELECT * FROM keluar k, stock s WHERE s.idbarang = k.idbarang AND tanggal BETWEEN ? AND DATE_ADD(?, INTERVAL 1 DAY)");
        ...
        <div class="modal-content">
            ...
            <form action="" method="post">
                <div class="modal-body">
                    ...
                    <br>
                    <input type="number" name="qty" class="form-control" placeholder="Jumlah Barang Keluar" required>
                    <br>
